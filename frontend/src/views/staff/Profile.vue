<template>
  <div class="min-h-screen bg-gray-100 pb-24">
      ...
      <div class="bg-white rounded-xl p-4 shadow-sm mb-4">
        ...
        <div class="space-y-3">
          ...
          <div class="flex justify-between items-center py-2">
            <span class="text-gray-500">负责业务</span>
            <span class="text-gray-800">{{ user?.department || '未设置' }}</span>
          </div>
        </div>
      </div>
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 flex justify-around">
      ...
      <button @click="navigateTo('/staff/profile')" class="flex flex-col items-center text-green-500">
        <span class="text-2xl">👤</span>
...
const editProfile = async () => {
  ...
  try {
    ...
    currentUser.user.department = profileForm.department
